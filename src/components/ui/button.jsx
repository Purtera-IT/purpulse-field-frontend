  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Enterprise CTA — rectangular, brand color, token radius + shadow
        enterprise:
          "bg-[#0B2D5C] text-white font-semibold shadow-[0_2px_6px_rgba(15,23,36,0.18)] hover:bg-[#0B66B2] active:opacity-90 rounded-[8px]",
      },
      size: {
        ...
        icon: "h-9 w-9",
        // Enterprise mobile-safe touch target
        enterprise: "h-11 min-h-[44px] px-5 py-2.5 text-sm rounded-[8px]",
      },
    },
    defaultVariants: {
      variant: "default",
